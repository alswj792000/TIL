...
> \\: 역슬래시 기호를 단일로 사용할 경우 'escape'의 성격을 띠며 원래의 의미를 벗어나 새로운 기능을 하게 됨. <br>[ escape : https://doongi9.tistory.com/entry/Escape​ ]<br> \n : 줄바꿈 기호.<br> \r : 다음 줄 맨 처음으로 가는 역할<br> \" : 큰 따옴표를 그냥 쓰게 되면 다른 의미로 받아들여 큰 따옴표를 직접 쓸 때 역슬래시를 써줌.<br> \' : 작은 따옴표 또한 큰 따옴표와 같다.<br> \\ : 역슬래쉬 하나를 출력한다.<br>
<br>
